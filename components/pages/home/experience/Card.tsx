        ...
        >
          {experience.technologies && experience.technologies.length > 0 ? (
            experience.technologies.map((technology) => (
              ...
              >
                <div
                  className="group/tech inline-block h-full w-full cursor-default rounded-md border border-white/5 bg-white/5 p-1 transition-colors duration-300 hover:border-emerald-500/50 focus-visible:outline-none"
                  role="img"
