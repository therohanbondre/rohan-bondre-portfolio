    ...
    >
      ...
      >
        {Technologies.map((technology: Technology) => (
          <li
            key={technology.id}
            className="group/tech relative flex w-full cursor-default items-center justify-center rounded-xl p-2 transition-colors duration-300 sm:hover:bg-white/5"
          >
            {/* Focusable wrapper: role="img" makes intent clear to screen readers */}
            <div
              role="img"
              aria-label={technology.name}
              tabIndex={0}
              className="flex w-full items-center justify-center focus-visible:outline-none"
            >
              <TechnologyIcon
